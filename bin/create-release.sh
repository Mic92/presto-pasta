...
# flake.nix reads the version from Cargo.toml.
...
pr_url=$(gh pr create \
  ...
  --body "Release ${version} of presto-pasta")
...
git pull git@github.com:Mic92/presto-pasta main
# The v* tag created by the release triggers .github/workflows/release.yml,
# which publishes to crates.io via trusted publishing.
